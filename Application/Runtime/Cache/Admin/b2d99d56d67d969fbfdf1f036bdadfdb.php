...
<!-- markdown-body -->
  ...
  <ol class="breadcrumb glyphicon glyphicon-folder-open">
    ...
    <li class="active">edit</li>
        ...
        <div class="header">
            <h1 class="page-title">友情链接 - edit</h1>
        </div>

        <!-- edit form -->
        <form action="<?php echo U('Admin/Links/saveLink');?>" method="post" id="tab" enctype="multipart/form-data">
            ...
            <div class="tab-content">         
                <div class="active" id="basic">
                    ...
                    <div class="well">
                        ...
                        <input type="text" name="title" value="<?php echo ($res["title"]); ?>">&emsp;
&emsp;
                    ...
                    <div class="tab-pane fade in" id="desc">
                        <div class="well">
                            <label>内容：</label>
                            <textarea style="width: 95%;height: 300px;" name="content" class="input-xlarge"><?php echo ($res["content"]); ?></textarea>
                        </div><!-- end well -->
                    </div>
