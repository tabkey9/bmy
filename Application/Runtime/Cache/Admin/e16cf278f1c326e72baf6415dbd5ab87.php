...
<!--首页静态导航栏 begin-->
            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="basic">
                    <div class="well">
                        ...
                        <label>文章分类： </label>
                        <select name="cate_id">
                            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["cate_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                    <div class="tab-pane fade in" id="desc">
                        <div class="well">
                     <label>文章简介：</label>
                        <textarea id="editor" style="width: 1024px;height: 500px;" name="content" class="input-xlarge"></textarea>
                       </div>
                    </div> 
                </div>
                <input type="hidden" name="md" value="0"></input>
                <input type="hidden" name="user_id" value="<?php echo ($_SESSION['manager_info']['id']); ?>"></input>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $('.add').click(function(){
                var add_div = '<div>[<a href="javascript:void(0);" class="sub">-</a>]文章图片：<input type="file" name="goods_pics[]" value="" class="input-xlarge"></div>';
