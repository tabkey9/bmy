            ...
            <div class="tab-content">         
                <div class="active" id="basic">
                    ...
                    <div class="well">
                        ...
                        <input type="text" name="url" value="<?php echo ($data["url"]); ?>">&emsp;&emsp;
                    ...
                    <div class="tab-pane fade in" id="desc">
                        <div class="well">
                            <label>链接介绍：</label>
                            <textarea style="width: 95%;height: 300px;" name="explain" class="input-xlarge"><?php echo ($data["explain"]); ?></textarea>
                        </div><!-- end well -->
                    </div>
