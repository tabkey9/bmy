            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="basic">
                   <div class="well">
                        ...
                        <input type="text" name="title" value="<?php echo ($res["title"]); ?>" class="input-xlarge">
                        <label>文章分类： </label>
                        <select name="cate_id">
                            ...
                            <?php if( $res["cate_id"] == $v["id"] ): ?>selected<?php endif; ?> ><?php echo ($v["cate_name"]); ?>
                            </option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                        <label>文章内容：</label>
                        <textarea id="editor" style="width: 85%;height: 350px;" name="content" class="input-xlarge"><?php echo ($res["content"]); ?></textarea>
                    </div>
                </div>
                
                <input type="hidden" name="md" value="<?php echo ($res["md"]); ?>"></input>
                <input type="hidden" name="user_id" value="<?php echo ($res["user_id"]); ?>"></input>
