...
<!-- markdown-body -->
  ...
  <ol class="breadcrumb glyphicon glyphicon-folder-open">
    ...
    <li><a href="<?php echo U('Admin/Links/index');?>">Link</a></li>
    <li class="active">index</li>
  </ol>
  <div class="panel panel panel-info">
      <div class="panel-heading">
      <span class="panel-title">链接管理 - lists<span class="pull-right"><a class="btn btn-heading" href="/Admin/Links/add">新增</a></span></span>
      </div>
            ...
            <table class="table table-bordered table-hover table-condensed">
                ...
                <tbody>
                    <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><tr class="info">
                            ...
                            <td><?php echo (date("Y-m-d h:i:s",$v["update"])); ?></td>
                            <td >
                                <a href="/Admin/Links/edit/id/<?php echo ($v["id"]); ?>"> 编辑 </a>&nbsp;
                                <a href="javascript:void(0);" onclick="if(confirm('确认删除？')) location.href='/Admin/Links/delLink/id/<?php echo ($v["id"]); ?>/'"> 删除 </a>
                            </td>
