...
<!--首页静态导航栏 begin-->
    ...
    <div class="content">
        ...
        <div class="well">
            <a class="btn btn-primary" href="/admin/auth/add">新增</a>
            <!-- table -->
            <table class="table table-bordered table-hover table-condensed">
                ...
                <tbody>
                     <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr class="success">
                        ...
                        <td>
                            <a href="/admin/auth/edit/id/<?php echo ($vol["id"]); ?>"> 编辑 </a>
                            <a href="javascript:void(0);" onclick="if(confirm('确认删除？')) location.href='/admin/auth/del/id/<?php echo ($vol["id"]); ?>'"> 删除 </a>
                        </td>
