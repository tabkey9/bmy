...
<div id="page">
	<table>
		<tr>
			<th class="w_logo">SERVER_INFO</th>
		</tr>
	</table>
<!--服务器相关参数-->
...
<table>
  ...
  <tr>
    ...
    <td colspan="3">服务器域名：<?php echo $_SERVER['SERVER_NAME'];?>&nbsp;&nbsp;你的IP地址是：<?php echo @$_SERVER['REMOTE_ADDR'];?></td>
...
<table>
  ...
  <tr>
    ...
    <td>Memcached 内存对象缓存系统：</td>
    <td><?php echo isfun("memcached_close"); ?></td>
  </tr>
	...
	<table>
		<tr>
			<td class="w_foot"><A HREF="javascript:void(0)" target="_blank"><?php echo $title.$version;?></A></td>
			<td class="w_foot"><?php $run_time = sprintf('%0.4f', microtime_float() - $time_start);?>响应时间: <?php echo $run_time?> /s,占用内存： <?php echo memory_usage();?>.</td>
